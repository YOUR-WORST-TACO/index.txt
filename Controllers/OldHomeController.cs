...
/*namespace Index.txt.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(TodoModelDbContext context)
        {
            ...
            var toDos = new[]
            {
                new TodoItem {Description = "Build more Legos and stuff"},
            ...
            _context.AddRange(
                ...
                new KeyValue { TodoItem = toDos[1], Key = "due", Value = "never" },
                new KeyValue { TodoItem = toDos[1], Key = "pri", Value = "A"}
            );
